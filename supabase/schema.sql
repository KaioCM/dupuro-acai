...
-- ---------- Sessão de caixa (abrir/fechar) (migration_028) ----------
-- Cada abertura é uma sessão; vendas ficam amarradas por orders.caixa_sessao_id.
-- Abrir informa o fundo de troco; fechar confere o dinheiro (esperado vs contado).
...
-- ---------- Custos de produção por leva (migration_024) ----------
-- Uma leva = gastos (linhas por categoria) + produtos produzidos. O custo por
-- litro = gasto_total / litros_totais, e cada produto é rateado por volume.
-- Tudo admin-only: custo/lucro é sensível (atendente e revendedor não veem).
